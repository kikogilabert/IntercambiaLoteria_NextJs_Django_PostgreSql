...
urlpatterns = [
    ...
    # Get profile data (GET)
    path("admon/<int:id_administracion>/get/", AdministracionView.as_view(), name="admon-get"),
    # Update profile data (PATCH OR PUT)
    path("admon/<int:id_administracion>/update/", AdministracionView.as_view(), name="admon-update"),
]
